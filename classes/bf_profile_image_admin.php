...
class bf_profile_image_admin {
	...
	public function buddyforms_after_activate_user( $user_id ) {
		global $bp;
	...
	public function buddyforms_crop_profile_picture( $args = array() ) {
	...
	public function buddyforms_crop_profile_picture_registration( $args = array() ) {
	...
	public function buddyforms_profile_picture_user_registration_ended( $args ) {
		global $bp;
