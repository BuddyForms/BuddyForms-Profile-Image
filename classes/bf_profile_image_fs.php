...
class bf_profile_image_fs {
    ...
    public static function getFreemius() {
        global $bf_profile_image_fs;

        return $bf_profile_image_fs;
    }
    ...
    public function bf_profile_image_fs() {
        global $bf_profile_image_fs;

        if ( ! isset( $bf_profile_image_fs ) ) {
            // Include Freemius SDK.
            require_once dirname( __FILE__ ) . '/include/freemius/start.php';

            $bf_profile_image_fs = fs_dynamic_init( array(
                'id'                  => '415',
